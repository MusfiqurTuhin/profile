        ...
        <section id="travel" className="min-h-screen w-full py-20 md:py-32 px-6 bg-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              `}</style>
                            ...
                            <div className="absolute top-4 right-4 md:top-4 md:right-4 bg-white/95 backdrop-blur-sm border border-stone-300 rounded-lg p-3 md:p-4 shadow-md z-[1000]">
                                <div className="text-right space-y-1">
                                    <div className="text-2xl md:text-4xl font-black text-red-600">{visitedCount}</div>
                                    <div className="text-[10px] md:text-xs font-mono text-stone-500">DISTRICTS</div>
                                    <div className="text-[10px] md:text-xs text-stone-400 border-t border-stone-200 pt-1 mt-1">
                        ...
                        <div className="mt-4 grid grid-cols-3 gap-3 text-center">
                            <div className="bg-stone-50 border border-stone-200 rounded-lg p-3">
                                <div className="text-lg md:text-xl font-bold text-stone-900">{travelData.stats.visitedDivisions}</div>
                                <div className="text-[10px] font-mono text-stone-500 uppercase">Divisions</div>
                            </div>
                            <div className="bg-stone-50 border border-stone-200 rounded-lg p-3">
                                <div className="text-lg md:text-xl font-bold text-stone-900">{visitedCount}</div>
                                <div className="text-[10px] font-mono text-stone-500 uppercase">Districts</div>
                            </div>
                            <div className="bg-stone-50 border border-stone-200 rounded-lg p-3">
                                <div className="text-lg md:text-xl font-bold text-red-600">{visitedPercentage}%</div>
